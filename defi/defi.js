...
async function chargerBanque() {
  ...
  // attendre le re-téléchargement des 2 000 questions (~620 Ko à chaque
...
function tirage(mode, filtres) {
  if (mode === 'jour') {
    ...
    // (~200 jours avec 2 000 questions). Tout dérive de la date : même défi
...
/* ============================================================================
   ...
   2 000 questions ont été relues deux fois devant le texte. Elles restent
   écrites par des humains : la personne qui verra la 2 001e coquille, c'est le
